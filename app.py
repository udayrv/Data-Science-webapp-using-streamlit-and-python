...
Data_URL = ("D:\webapp\Motor_Vehicle_Collisions_-_Crashes.csv")
...
st.header("Number  of Collisions occured in a given hour of the day")
...
if 6 <= hour <= 18:
    day_light('mapbox://styles/mapbox/light-v9')
else:
    day_light('mapbox://styles/mapbox/dark-v9')
